...
const HeadCategory = () => {
  ...
  return (
    <section>
      <div className="flex w-[100%] bg-gray-200 p-2">
        <div className="flex w-[100%] hover:duration-200 max-lg:hidden justify-evenly items-center book-style">
          {/* desktop mode */}
        ...
        <div className="flex md:w-full max-sm:w-100% h-fit lg:hidden ">
          ...
          >
            ...
            <ul className="max-sm:w-fit max-sm:flex max-sm:flex-wrap relative">
              <Link
                to={"/allgen/bacII"}
                className="sm:text-sm md:text-md sm:text-sm xs:text-sm rounded-lg p-2 text-slate-700 font-medium hover:bg-slate-100 hover:text-slate-900"
              >
                បាក់ឌុប
              </Link>
              <Link
                to={"/allgen/comdy"}
                className=" md:text-md sm:text-sm xs:text-sm  hover:shadow-full rounded-lg p-2 text-slate-700 font-medium hover:bg-slate-100 hover:text-slate-900"
              >
                កំប្លែង
              </Link>
              <Link
